...
export const PROPERTY_LAYER_CATALOG = freeze([
  { id:'ownership-history',label:'Ownership observations',group:'ownership',access:'public',geometry:'observation-points',jurisdictions:['st-louis-county'],sourceIds:[],capabilities:['dated-name-changes'],color:'#e6bc77',coverage:'Changes between successful complete County name-indicator observations, beginning with the saved baseline.',meaning:'An observation change is not a deed, acquisition date, or evidence of private-equity control.' },
  { id:'planning-documents',label:'Planning document trail',group:'development',access:'public',geometry:'documents',jurisdictions:['st-louis-city','st-louis-county'],sourceIds:[],capabilities:['official-document-links'],color:'#c3a3e7',coverage:'Documents found on connected official planning, preservation, incentive and capital-plan indexes. Unlocated records remain in the feed.',meaning:'A document or meeting agenda does not establish approval or construction.' },
  { id:'tif-districts',label:'TIF districts',group:'development',access:'public',geometry:'representative-polygon-points',jurisdictions:['st-louis-city'],sourceIds:[],capabilities:['source-polygons','source-case-fields'],color:'#e4b570',coverage:'City published TIF polygons; source dates and unverified status codes remain visible.',meaning:'Markers represent source polygons, not individual properties or confirmed current incentives.' },
  { id:'tax-abatements',label:'Recorded tax abatements',group:'development',access:'public',geometry:'representative-polygon-points',jurisdictions:['st-louis-city'],sourceIds:[],capabilities:['recorded-abatement-period'],color:'#a7bf87',coverage:'City published abatement inventory and recorded start/end years.',meaning:'A recorded period is not confirmation of current eligibility, tax savings, or the actual tax bill.' },
  { id:'water-materials',label:'Water-service materials',group:'utilities',access:'public',geometry:'source-inventory-points',jurisdictions:['st-louis-city'],sourceIds:[],capabilities:['utility-side-material','customer-side-material','inventory-evidence'],color:'#77cbd3',coverage:'City Water Division service-line inventory. County water infrastructure is not connected.',meaning:'Utility and customer sides can differ. Inventory materials and evidence are not a water-quality test or an as-built line map.' },
