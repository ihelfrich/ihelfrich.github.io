...
export async function GET({ site }) {
  ...
  const records = [
    ...
    ...talks.map((entry) => ({ type: "talk", title: entry.data.title, date: entry.data.date.toISOString(), venue: entry.data.venue, upcoming: entry.data.upcoming, url: new URL("/talks/", base) })),
  ];
